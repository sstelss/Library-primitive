...
$m = $myconnect -> get_book("*", "`User`", "`Login`", $name);


echo "<table cellspacing=\"18\">";
echo '<tr>';
echo '<td>ID</td><td>Login</td><td>Name</td><td>Sub_name</td><td>Year</td><td>Password</td>';
echo'</tr>';
foreach($m as $v)
{
echo "<tr>";
echo "<td>".$v['ID']."</td> <td>".$v['Login']."</td><td>".$v['Name']."</td><td>".$v['Sub_name']."</td><td>".$v['Date']."</td><td>".$v['Password']."</td>";
